<footer id="footer" class="mt-40">
    ...
    <div class="md:h-80 md:flex relative bg-footer justify-center items-center text-white">
        ...
        <div class="bg-white-laravel h-40 w-40 rounded-full flex justify-center items-center absolute top-1/2 left-1/2 transform translate-y-1/4 md:translate-y-0 -translate-x-1/2 -top-1/4" style="background-color:#F3F4F6">
