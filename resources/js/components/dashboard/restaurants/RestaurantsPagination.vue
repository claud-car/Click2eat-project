<template>
    ...
    <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
        <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
            ...
            <div v-if="!filteredRestaurants.length && search" class="flex justify-center w-full px-5 py-5 border-b border-gray-200 bg-white text-sm">
                <p>Your search request returned no results.</p>
            </div>
            <div v-if="!filteredRestaurants.length && !search" class="flex justify-center w-full px-5 py-5 border-b border-gray-200 bg-white text-sm">
                <p>There aren't restaurants to display here yet. Let's add one.</p>
            </div>
