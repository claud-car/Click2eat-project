<template>
    <header class="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-yellow">
        ...
        <div class="flex items-center">
            ...
            <div x-data="{ dropdownOpen: false }"  class="relative">
                ...
                <div v-show="dropdownOpen" class="absolute right-0 mt-2 w-48 bg-white rounded-md overflow-hidden shadow-xl z-10 cursor-pointer">
